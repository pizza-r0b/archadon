...
var _ProductTile = __webpack_require__(52);
...
var _ClearFilterButton = __webpack_require__(24);
...
function ProductList(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    null,
    !hideFav && _react2.default.createElement(_Filters2.default, null),
    _react2.default.createElement(
      'div',
      { className: 'flex-grow-1 flex-parent flex-col margin--bottom-10' },
      _react2.default.createElement(
        'div',
        { className: 'margin--top-3 margin--bottom-6 flex-grow-1 flex-parent flex-wrap ' + (className ? '' + className : 'flex-align-center flex-justify-center') },
        ...
        products.length === 0 && _react2.default.createElement(
          'div',
          { className: 'flex-parent flex-align-center flex-col flex-justify-center' },
          _react2.default.createElement(
            'h2',
            { className: 'margin--bottom-6' },
            'Your filters returned no results. Try a different combination of filters or'
          ),
          _react2.default.createElement(_ClearFilterButton2.default, null)
        )
      ),
      !hideBtn && page < nbPages && _react2.default.createElement(
        'div',
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ON_CLEAR_FILTERS, 'ON_CLEAR_FILTERS', '/Users/realseanp1/Projects/archadon/src/client/components/ProductList.jsx');
...
var _ProductList = __webpack_require__(22);
...
var _Account = __webpack_require__(39);

var _Account2 = _interopRequireDefault(_Account);

var _SignInForm = __webpack_require__(54);

var _SignInForm2 = _interopRequireDefault(_SignInForm);

var _Checkout = __webpack_require__(42);

var _Checkout2 = _interopRequireDefault(_Checkout);

var _ProductDetail = __webpack_require__(50);
...
var _OrderConfirmation = __webpack_require__(48);
...
var _spritesheet = __webpack_require__(74);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { style: { paddingTop: '35px' }, className: 'flex-grow-1 flex-justify-center flex-parent' },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_reactRouterDom.Route, { path: '/(login|signup)', render: function render(_ref3) {
...
var composeEnhancers = typeof window !== 'undefined' && process.NODE_ENV !== 'production' ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || _redux.compose : _redux.compose;
...
var _algoliasearch = __webpack_require__(75);
...
var _AccountLayout = __webpack_require__(40);
...
var _Orders = __webpack_require__(49);

var _Orders2 = _interopRequireDefault(_Orders);

var _Favorites = __webpack_require__(43);
...
var _ProductDetailLink = __webpack_require__(51);
...
var LOADING = _Actions2.default.LOADING,
    HOME_LOADED = _Actions2.default.HOME_LOADED;


var preload = function preload(images) {
  return _promise2.default.all(images.map(function (src) {
...
var Home = function (_React$Component) {
  ...
  function Home() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Home.__proto__ || (0, _getPrototypeOf2.default)(Home)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      currentIndex: 0,
      loaded: _this.props.homeIsLoaded
    }, _this.scroll = function () {
      if (_this.velocityScroll) {
        _this.velocityScroll();
      }
    }, _this.Cta = function () {
      return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          'button',
          { onClick: _this.scroll, className: 'btn btn--white margin--top-5' },
          'Shop Selection'
        )
      );
    }, _this.images = [_Constants.IMAGE_ORIGIN + '/hp-artisan-rugs.jpg'], _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  (0, _createClass3.default)(Home, [{
    ...
    value: function componentDidMount() {
      ...
      if (!this.props.homeIsLoaded) {
        ...
        preload(this.images).then(function () {
          _this2.props.setLoadingState(false);
          _this2.setState({ loaded: true });
          _this2.props.homeLoaded();
        });
      }

      Promise.resolve().then(__webpack_require__.bind(null, 78)).then(function (Velocity) {
        _this2.velocityScroll = function () {
          Velocity(_this2.selection, 'scroll', {
            duration: 1000,
            easing: 'easeOutExpo'
          });
        };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'section',
          { className: 'hero' },
          _react2.default.createElement('img', { className: 'main-image', alt: 'Handmade Artisan Rugs', src: this.images[0] }),
          _react2.default.createElement(
            'div',
        ...
        _react2.default.createElement(
          'section',
          { className: 'content-grid global-padding' },
          _react2.default.createElement(
            'div',
            { className: 'content-grid-inner collection' },
            _react2.default.createElement(
              'div',
              { className: 'grid-item collection-a' },
              _react2.default.createElement('img', { src: 'https://assets.archadon.com/6x9.2_32397_29426_v2.jpg' })
            ),
            _react2.default.createElement(
              'div',
              { className: 'grid-item flex-col collection-b' },
              _react2.default.createElement(
                'h1',
                { className: 'align--center' },
              ...
              _react2.default.createElement(
                'p',
                { className: 'align--center' },
                'A blend of modern with traditional.'
              ),
              _react2.default.createElement(
                'div',
                { className: 'btn btn--first margin--top-4' },
                'View Collection'
              )
            ),
            _react2.default.createElement(
              'div',
              { className: 'grid-item collection-c' },
              _react2.default.createElement('img', { src: 'https://assets.archadon.com/6x9_32394_29429_v2.jpg' })
            )
          )
        ),
        _react2.default.createElement(
          ...
          this.state.loaded && _react2.default.createElement(_Shop2.default, null)
        ),
        _react2.default.createElement(
          'section',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    setLoadingState: function setLoadingState(state) {
      dispatch((0, _Utils.action)(LOADING, state));
    },
    homeLoaded: function homeLoaded() {
      dispatch((0, _Utils.action)(HOME_LOADED));
    }
  };
};
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(LOADING, 'LOADING', '/Users/realseanp1/Projects/archadon/src/client/components/Home.jsx');

  __REACT_HOT_LOADER__.register(HOME_LOADED, 'HOME_LOADED', '/Users/realseanp1/Projects/archadon/src/client/components/Home.jsx');

  __REACT_HOT_LOADER__.register(preload, 'preload', '/Users/realseanp1/Projects/archadon/src/client/components/Home.jsx');
...
function Navigation(_ref) {
  ...
  return _react2.default.createElement(
    'nav',
    {
      ...
      className: (0, _classnames2.default)('global-nav global-padding-x flex-justify-between flex-align-center', {
        open: navOpen
      })
    },
    _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'global-nav-links flex-parent flex-align-center' },
      _react2.default.createElement(
        'div',
        { onClick: function onClick() {
            toggleNav(navOpen);
          }, className: 'global-nav-link close' },
        'Close'
      ),
      _react2.default.createElement(
        'div',
      ...
      user.authToken && user.ID ? [_react2.default.createElement(
        'div',
        { className: 'global-nav-link', key: 'a' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: '/account' },
          'My Account'
        ...
        'div',
        { className: 'global-nav-link', key: 'b' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: '/logout' },
          'Log Out'
        ...
        'div',
        { className: 'global-nav-link', key: 'c' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: '/login' },
          'Log In'
        ...
        'div',
        { className: 'global-nav-link', key: 'd' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: '/signup' },
          'Sign Up'
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Svg2.default, { variant: 'icon-cart', color: 'currentColor' })
        ),
        _react2.default.createElement(
          'div',
          null,
...
var _AddToCartBtn = __webpack_require__(55);

var _AddToCartBtn2 = _interopRequireDefault(_AddToCartBtn);

var _FavoriteBtn = __webpack_require__(25);
  ...
  function Filters() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = Filters.__proto__ || (0, _getPrototypeOf2.default)(Filters)).call.apply(_ref2, [this].concat(args))), _this), _this.onChange = function (e) {
      ...
      _this.props.updateFilter({
        queries: queries, type: type, field: field
      });
    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          FILTERS_ARR.map(function (filter, i) {
            filter.index = i;
            return _react2.default.createElement(FilterOption, { defaultIndex: _this2.props.filters.length, key: i, onChange: _this2.onChange, filter: filter });
          })
        )
      );
    }
...
var _redirectPath = __webpack_require__(65);
...
var _orderConfirmation = __webpack_require__(62);

var _orderConfirmation2 = _interopRequireDefault(_orderConfirmation);

var _productDetails = __webpack_require__(63);
