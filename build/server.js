...
function Cart(_ref2) {
  ...
  return _react2.default.createElement(
    ...
    items.length > 0 && _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'flex-parent flex-align-center cart-header' },
        _react2.default.createElement(
          'h2',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !this.props.loading && _react2.default.createElement(
          ...
          _react2.default.createElement(
            'form',
            { className: 'checkout-form', onSubmit: this.submit },
            _react2.default.createElement(
              'h2',
              { className: 'margin--bottom-3' },
              '1. Information'
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                this.addClasses(_react2.default.createElement('input', { onChange: this.onDataChange, value: this.state.data.name, name: 'name', type: 'text' })),
                _react2.default.createElement(
                  'label',
                  null,
                  'Full Name'
              ...
              _react2.default.createElement(
                ...
                this.addClasses(_react2.default.createElement('input', { 'data-regex': 'email', value: this.state.data.email, onChange: this.onDataChange, name: 'email', type: 'email' }))
              ),
              _react2.default.createElement(
                'div',
              ...
              _react2.default.createElement(
                ...
                this.addClasses(_react2.default.createElement('input', { onChange: this.onDataChange, value: this.state.data.address1, name: 'address1', type: 'text' }))
              ),
              _react2.default.createElement(
                'div',
                { className: 'form-component margin--top-3' },
                ...
                this.addClasses(_react2.default.createElement('input', { onChange: this.onDataChange, value: this.state.data.address2, name: 'address2', type: 'text' }))
              ),
              _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                  ...
                  this.addClasses(_react2.default.createElement('input', { onChange: this.onDataChange, value: this.state.data.city, name: 'city', type: 'text' }))
                ),
                _react2.default.createElement(
                  'div',
                  ...
                  this.addClasses(_react2.default.createElement('input', { onChange: this.onDataChange, value: this.state.data.state, name: 'state', type: 'text' }))
                ),
                _react2.default.createElement(
                  'div',
                  { className: 'form-component margin--top-3' },
                  ...
                  this.addClasses(_react2.default.createElement('input', { onChange: this.onDataChange, value: this.state.data.zip, name: 'zip', type: 'text' }))
                )
              ),
              _react2.default.createElement(
                'div',
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  this.addClasses(_react2.default.createElement('input', { placeholder: 'MM', 'data-regex': 'expMonth', value: this.state.cardDetails.expMonth, onChange: this.onCardChange, name: 'expMonth', type: 'text' }), this.state.cardDetails.expMonth)
                ),
                _react2.default.createElement(
                  'div',
                  ...
                  this.addClasses(_react2.default.createElement('input', { placeholder: 'YYYY', 'data-regex': 'expYear', value: this.state.cardDetails.expYear, onChange: this.onCardChange, name: 'expYear', type: 'text' }), this.state.cardDetails.expYear)
                ),
                _react2.default.createElement(
                  'div',
                  { className: 'form-component margin--top-3 flex-grow-1 flex-parent flex-col flex-justify-end' },
                  ...
                  this.addClasses(_react2.default.createElement('input', { 'data-regex': 'expYear', placeholder: '000(0)', onChange: this.onCardChange, value: this.state.cardDetails.cvc, name: 'cvc', type: 'text' }), this.state.cardDetails.cvc)
                )
              ),
              _react2.default.createElement(
                'div',
