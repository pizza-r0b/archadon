...
var IMAGE_ORIGIN = exports.IMAGE_ORIGIN =  true ? 'https://assets.dev.archadon.com' : 'https://assets.archadon.com';
...
var _ProductDetailLink = __webpack_require__(16);
...
var _spritesheet = __webpack_require__(87);
...
var indexPrefix =  false ? 'prod' : 'dev';
...
function About() {
  return _react2.default.createElement('div', { className: 'wrap' });
}
...
var _HeroHeader = __webpack_require__(66);
...
var _reactTransitionGroup = __webpack_require__(89);
...
function Navigation(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _reactRouterDom.Link,
        { to: user ? '/account' : '/login', className: 'margin--right-10 small-caps account-link' },
        'Account'
      ),
      _react2.default.createElement(
        _reactRouterDom.Link,
...
var _ProductTile = __webpack_require__(59);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return Promise.resolve().then(__webpack_require__.bind(null, 90));
...
var API_URL =  true ? 'https://gnr9itw1e2.execute-api.us-east-1.amazonaws.com/dev/' : 'https://api.archadon.com/prod/';
...
app.listen(__webpack_require__.i({"NODE_ENV":"development"}).PORT || 8081, function () {
  console.log('App listening on port ' + (__webpack_require__.i({"NODE_ENV":"development"}).PORT || 8081)); //eslint-disable-line
});
;
...
module.exports.AppContainer = __webpack_require__(83);
